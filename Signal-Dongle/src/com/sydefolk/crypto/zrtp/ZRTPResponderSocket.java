...
import com.sydefolk.crypto.zrtp.retained.ResponderRetainedSecretsCalculator;
import com.sydefolk.crypto.zrtp.retained.RetainedSecrets;
import com.sydefolk.crypto.zrtp.retained.RetainedSecretsCalculator;
import com.sydefolk.crypto.zrtp.retained.RetainedSecretsDerivatives;
...
public class ZRTPResponderSocket extends ZRTPSocket {
  ...
  public ZRTPResponderSocket(SecureRtpSocket socket,
                             byte[] localZid,
                             boolean includeLegacyHeaderBug)
  {
    super(socket, localZid, EXPECTING_HELLO);
